...
export const PERSON_CREATE_RESEARCH_POST_REQUEST =
  'PERSON_CREATE_RESEARCH_POST_REQUEST'
export const PERSON_CREATE_RESEARCH_POST_SUCCESS =
  'PERSON_CREATE_RESEARCH_POST_SUCCESS'
export const PERSON_CREATE_RESEARCH_POST_FAIL =
  'PERSON_CREATE_RESEARCH_POST_FAIL'
export const PERSON_CREATE_RESEARCH_POST_RESET =
